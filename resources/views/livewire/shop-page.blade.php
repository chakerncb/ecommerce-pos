<section class="products-filter-page section">
    ...
    <button class="filter-mobile-toggle" id="shopFilterToggle" aria-expanded="false" aria-controls="shopFilterPanel">
    ...
    <div class="filter-category-card" id="shopFilterPanel">
        <h3>Filter :</h3>
